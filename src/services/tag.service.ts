...
class TagsService extends ResolverOperationsServices {
  ...
  async delete() {
    ...
    const result = await this.remove(this.collection, { id }, "genero");
  ...
  private async checkInDatabase(value: string) {
    return await findOneElement(this.collection, this.getDb(), {
      name: value,
    });
  }
}
